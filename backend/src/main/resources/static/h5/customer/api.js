...
(function(){
  ...
  var api = {
    ...
    // 顾客
    customer: {
      sendCode: function(phone){ return formRequest('POST', '/api/customer/auth/send-code', { userPhone: phone }); },
      login:    function(phone, code){ return formRequest('POST', '/api/customer/auth/login', { userPhone: phone, code: code }); },
      wallet:   function(phone){ return request('GET', '/api/customer/wallet/' + encodeURIComponent(phone)); },
      drawNormal: function(phone, mno){ return formRequest('POST', '/api/customer/draw/normal', { userPhone: phone, merchantNo: mno||'M1001' }); },
      ...
      ibigouOrder:  function(body){ return formRequest('POST', '/api/customer/ibigou/order', body); },
      ...
      messagesReadAll: function(phone){ return formRequest('POST', '/api/customer/messages/read-all', { userPhone: phone }); },
      qrSvg: function(content){ return formRequest('POST', '/api/customer/qr-svg', { content: content }); },
    ...
    merchant: {
      ...
      qrVerify: function(tk){ return request('GET', '/api/merchant/qr/verify?qrToken=' + encodeURIComponent(tk)); },
        ...
        enablePrizePool: function(id){ return request('POST', '/api/merchant/config/prize-pools/' + id + '/enable', {}); },
        disablePrizePool: function(id){ return request('POST', '/api/merchant/config/prize-pools/' + id + '/disable', {}); },
        deletePrizePool: function(id){ return request('DELETE', '/api/merchant/config/prize-pools/' + id); },
